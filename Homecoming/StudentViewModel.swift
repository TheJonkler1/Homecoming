...
class StudentViewModel {
    ...
    func setSearchFirstName(_ name: String) {
        searchedFirstName = name
        searchThroughDatabase2(firstName: name)
    }
    ...
    func searchThroughDatabase2(firstName: String) {
        let predicate = NSPredicate(format: "firstName == %@", searchedFirstName ?? "")
        let query = CKQuery(recordType: "Students", predicate: predicate)
